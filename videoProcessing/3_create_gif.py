...
# subclip.write_gif(output_path1, fps = 10, program='ffmpeg')


w, h = clip.size
subclip2 = clip.subclip(10,20)
cropped_clip = crop(subclip2, width= 320, height =320, x_center = w/2, y_center = h/2)

cropped_clip.write_gif(output_path2, fps = 10, program = 'ffmpeg')
